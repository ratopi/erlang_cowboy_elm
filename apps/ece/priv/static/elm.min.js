...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.ar, true);
		} catch (e) {
...
var author$project$Main$GotCounter = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Main$counter_json_decode = A2(elm$json$Json$Decode$field, 'counter', elm$json$Json$Decode$int);
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, av: r.av, X: r.X, e: r.e, h: r.h, i: r.i, j: r.j, ar: r.ar}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{av: elm$http$Http$emptyBody, X: r.X, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, ar: r.ar});
};
var author$project$Main$get_counter = elm$http$Http$get(
	{
		X: A2(elm$http$Http$expectJson, author$project$Main$GotCounter, author$project$Main$counter_json_decode),
		ar: 'counter'
	});
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Main$Loading, author$project$Main$get_counter);
};
...
var author$project$Main$Counter = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$Failure = {$: 0};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Main$decrement = function (model) {
	switch (model.$) {
		case 0:
		...
		case 2:
			return _Utils_Tuple2(
				author$project$Main$Counter(0),
				elm$core$Platform$Cmd$none);
		default:
			var n = model.a;
			return _Utils_Tuple2(
				author$project$Main$Counter(n - 1),
				elm$core$Platform$Cmd$none);
	}
};
var author$project$Main$increment = function (model) {
	switch (model.$) {
		case 0:
			return _Utils_Tuple2(author$project$Main$Failure, elm$core$Platform$Cmd$none);
		case 1:
		...
		switch (msg.$) {
			...
			case 1:
				...
				if (!result.$) {
					var n = result.a;
					return _Utils_Tuple2(
						author$project$Main$Counter(n),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(author$project$Main$Failure, elm$core$Platform$Cmd$none);
				}
			case 2:
				return author$project$Main$increment(model);
			case 3:
				return author$project$Main$decrement(model);
			default:
				var result = msg.a;
				if (!result.$) {
					var fullText = result.a;
					return _Utils_Tuple2(
						author$project$Main$Counter(1000),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(author$project$Main$Failure, elm$core$Platform$Cmd$none);
				}
...
var author$project$Main$counter_and_buttons = function (n) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$counter = function (model) {
	switch (model.$) {
		...
		default:
			var n = model.a;
			return author$project$Main$counter_and_buttons(n);
	}
};
...
var author$project$Main$counter_card = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('The Counter')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var author$project$Main$nav_bar = A3(
	elm$html$Html$node,
	'nav',
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('navbar'),
			elm$html$Html$Attributes$class('navbar-light'),
			elm$html$Html$Attributes$class('bg-light')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('ece is Erlang Cowboy Elm')
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$counter_card(model)
					]))
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{aC: author$project$Main$init, aL: author$project$Main$subscriptions, aN: author$project$Main$update, aO: author$project$Main$view});
