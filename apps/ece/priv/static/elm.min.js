...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.T, true);
		} catch (e) {
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, av: r.av, M: r.M, e: r.e, h: r.h, i: r.i, j: r.j, T: r.T}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{av: elm$http$Http$emptyBody, M: r.M, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, T: r.T});
};
var author$project$Main$get_counter = elm$http$Http$get(
	{
		M: A2(elm$http$Http$expectJson, author$project$Main$GotCounter, author$project$Main$counter_json_decode),
		T: 'counter'
	});
...
var author$project$Main$decrement = elm$http$Http$get(
	{
		M: A2(elm$http$Http$expectJson, author$project$Main$GotCounter, author$project$Main$counter_json_decode),
		T: 'counter/decrement'
	});
var author$project$Main$increment = elm$http$Http$get(
	{
		M: A2(elm$http$Http$expectJson, author$project$Main$GotCounter, author$project$Main$counter_json_decode),
		T: 'counter/increment'
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(model, author$project$Main$increment);
			default:
				return _Utils_Tuple2(model, author$project$Main$decrement);
		}
	});
